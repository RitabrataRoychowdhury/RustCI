...
spec:
  ...
  - type: Pods
    pods:
      metric:
        name: rustci_connections_active
      target:
        type: AverageValue
        averageValue: "1000"
  behavior:
...
data:
  prometheus.yml: |
    ...
    scrape_configs:
      ...
      - job_name: 'rustci-protocol'
        static_configs:
        - targets: ['rustci-api-service:8080']
        metrics_path: '/api/v1/rustci/metrics'
        scrape_interval: 5s
...
```json
{
  "dashboard": {
    ...
    "panels": [
      ...
      {
        "id": 2,
        "title": "RustCI Communication Protocol Performance",
        "type": "graph",
        "targets": [
          {
            "expr": "histogram_quantile(0.50, rustci_communication_latency_seconds)",
            "legendFormat": "P50 Latency"
          },
          {
            "expr": "histogram_quantile(0.95, rustci_communication_latency_seconds)",
            "legendFormat": "P95 Latency"
          },
          {
            "expr": "histogram_quantile(0.99, rustci_communication_latency_seconds)",
...
data:
  performance.yaml: |
    ...
    # RustCI communication protocol tuning
