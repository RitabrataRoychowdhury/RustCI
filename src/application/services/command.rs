...
use crate::{
    application::services::GitHubService,
    domain::entities::{GitHubBranch, GitHubCommit, GitHubPullRequest, PullRequestRequest},
...
impl CommandInvoker {
    ...
    pub async fn rollback(&mut self) -> Result<()> {
        tracing::info!(
            "Starting rollback of {} executed commands",
...
impl Command for CreatePullRequestCommand {
    ...
    fn description(&self) -> String {
        format!(
            "Create pull request '{}' from '{}' to '{}' in {}/{}",
            self.pr_request.title,
            self.pr_request.head,
            self.pr_request.base,
            self.pr_request.owner,
            self.pr_request.repo
        )
    }
...
impl Command for DockerfilePRWorkflowCommand {
    async fn execute(&self) -> Result<CommandResult> {
        ...
        Ok(CommandResult::Success(
            "Dockerfile PR workflow initiated".to_string(),
        ))
    }
...
mod tests {
    use super::*;
    use crate::application::services::GitHubService;
    use async_trait::async_trait;
    ...
    impl GitHubService for MockGitHubService {
        async fn get_user_info(
            &self,
            _access_token: &str,
        ) -> Result<crate::domain::entities::GitHubUser> {
            unimplemented!()
        }
        ...
        async fn get_user_repositories(
            &self,
            _access_token: &str,
        ) -> Result<Vec<crate::domain::entities::GitHubRepo>> {
            unimplemented!()
        }
        ...
        async fn get_repository_contents(
            ...
            _repo: &str,
            _path: &str,
        ) -> Result<Vec<crate::domain::entities::GitHubContent>> {
            unimplemented!()
        }
        ...
        async fn create_branch(
            ...
            _branch_name: &str,
            _from_branch: &str,
        ) -> Result<crate::domain::entities::GitHubBranch> {
            Ok(crate::domain::entities::GitHubBranch {
                name: _branch_name.to_string(),
                commit: crate::domain::entities::GitHubCommit {
        ...
        async fn create_file(
            ...
            _message: &str,
            _branch: &str,
        ) -> Result<crate::domain::entities::GitHubCommit> {
            Ok(crate::domain::entities::GitHubCommit {
        ...
        async fn create_pull_request(
            &self,
            _access_token: &str,
            _pr_request: &PullRequestRequest,
        ) -> Result<crate::domain::entities::GitHubPullRequest> {
            Ok(crate::domain::entities::GitHubPullRequest {
                id: 123,
                number: 1,
                ...
                merged: false,
                mergeable: Some(true),
                head: crate::domain::entities::GitHubBranch {
                ...
                base: crate::domain::entities::GitHubBranch {
                ...
                user: crate::domain::entities::GitHubUser {
                    id: 1,
