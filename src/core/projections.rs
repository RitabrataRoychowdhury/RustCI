...
use crate::core::event_sourcing::{EventProjection, EventStoreEntry};
use crate::core::events::{PipelineCompletedEvent, PipelineStartedEvent};
...
mod tests {
    use super::*;
    use crate::core::event_sourcing::EventStoreEntry;
