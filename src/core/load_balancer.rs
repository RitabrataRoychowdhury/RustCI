...
use crate::core::runner_pool::{LoadBalancer, SchedulingContext, RunnerRegistration};
...
mod tests {
    ...
    fn create_test_context(available_runners: Vec<RunnerId>, capacities: HashMap<RunnerId, RunnerCapacity>) -> SchedulingContext {
        SchedulingContext {
            ...
            strategy: crate::core::runner_pool::LoadBalancingStrategy::LeastLoaded,
            constraints: crate::core::runner_pool::SchedulingConstraints::default(),
        }
    }
