...
use super::{
    async_jobs::JobQueue,
    caching::{CacheManager, QueryCache, SessionCache},
    concurrency::{DeadlockDetector, DistributedLockManager, RateLimiter},
    correlation::CorrelationTracker,
    error_manager::{ErrorContext, ErrorManager},
    ...
    runtime_optimization::RuntimeOptimizer,
};
...
pub struct SystemStatus {
    ...
    pub metrics: super::metrics::MetricsSnapshot,
    pub queue_stats: super::async_jobs::QueueStats,
    pub cache_stats: HashMap<String, super::caching::CacheStats>,
    pub active_alerts: Vec<super::metrics::ActiveAlert>,
    pub error_stats: super::error_manager::ErrorStats,
...
pub struct ConcurrencyStats {
    ...
    pub rate_limit_stats: HashMap<String, super::concurrency::RateLimitStats>,
...
pub struct PerformanceStats {
    ...
    pub optimization_report: super::runtime_optimization::PerformanceReport,
}
...
async fn alerts_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<Vec<super::metrics::ActiveAlert>> {
...
async fn cache_stats_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<HashMap<String, super::caching::CacheStats>> {
...
async fn job_stats_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<super::async_jobs::QueueStats> {
...
async fn locks_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<Vec<(String, super::concurrency::LockInfo)>> {
...
async fn rate_limits_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<HashMap<String, super::concurrency::RateLimitStats>> {
...
async fn optimization_report_handler(
    axum::extract::State(service): axum::extract::State<Arc<ObservabilityService>>,
) -> axum::response::Json<super::runtime_optimization::PerformanceReport> {
