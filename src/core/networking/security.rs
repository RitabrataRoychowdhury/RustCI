    ...
    pub fn permissions(&self) -> HashSet<Permission> {
        match self {
            Role::Admin => {
                ...
                perms.insert(Permission::ScheduleJobs);
                perms.insert(Permission::ViewJobs);
                perms.insert(Permission::ManageNodes);
                perms.insert(Permission::ViewNodes);
            ...
            Role::Developer => {
                ...
                perms.insert(Permission::ViewArtifacts);
                perms.insert(Permission::CancelPipelines);
                // Control plane permissions for developers
                perms.insert(Permission::ScheduleJobs);
                perms.insert(Permission::ViewJobs);
                perms.insert(Permission::ViewNodes);
                perms.insert(Permission::ViewMetrics);
            ...
            Role::Viewer => {
                ...
                perms.insert(Permission::ViewLogs);
                perms.insert(Permission::ViewArtifacts);
                // Control plane view permissions
                perms.insert(Permission::ViewJobs);
                perms.insert(Permission::ViewNodes);
                perms.insert(Permission::ViewMetrics);
                perms
            ...
            Role::ServiceAccount => {
                ...
                perms.insert(Permission::ViewLogs);
                perms.insert(Permission::ViewArtifacts);
                // Control plane permissions for service accounts
                perms.insert(Permission::ScheduleJobs);
                perms.insert(Permission::ViewJobs);
                perms.insert(Permission::ManageNodes); // For node registration
                perms.insert(Permission::ViewNodes);
                perms
            }
        }
