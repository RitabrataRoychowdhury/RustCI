...
#[cfg(feature = "opentelemetry")]
use super::adapter_system::{AdapterHealth, HealthStatus, SpanId, SpanStatus, TracingAdapter};
...
impl OpenTelemetryAdapterFactory {
    ...
    ) -> Result<std::sync::Arc<dyn TracingAdapter>, OpenTelemetryAdapterError> {
...
#[cfg(not(feature = "opentelemetry"))]
impl OpenTelemetryAdapterFactory {
    pub async fn create_default() -> Result<
        std::sync::Arc<
            dyn crate::core::networking::valkyrie::observability::adapter_system::TracingAdapter,
        >,
    ...
    pub async fn create_from_env() -> Result<
        std::sync::Arc<
            dyn crate::core::networking::valkyrie::observability::adapter_system::TracingAdapter,
        >,
        Box<dyn std::error::Error>,
