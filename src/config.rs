...
impl Config {
    pub fn init() -> Config {
        ...
        let jwt_expires_in = std::env::var("JWT_EXPIRED_IN").unwrap_or_else(|_| "60m".to_owned());
        ...
        let client_origin = std::env::var("CLIENT_ORIGIN").unwrap_or_else(|_| "http://localhost:3000".to_owned());
