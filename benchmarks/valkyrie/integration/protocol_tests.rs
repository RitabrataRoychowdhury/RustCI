...
mod protocol_tests {
    ...
    async fn test_message_routing() {
        ...
        assert!(routing_result.is_ok(), "Message should be routed successfully");
    ...
    async fn test_error_handling() {
        ...
        assert!(connection_result.is_err(), "Connection to invalid endpoint should fail");
    ...
    async fn test_message_ordering() {
        ...
        for (i, message) in messages.into_iter().enumerate() {
            ...
            assert!(send_result.is_ok(), "Message {} should be sent successfully", i);
        }
    ...
    async fn test_backpressure_handling() {
        ...
        for i in 0..1000 {
            ...
            let task = tokio::spawn(async move {
                engine_clone.send_message(message).await
            });
        ...
        assert!(successful_sends > 0, "At least some messages should be sent successfully");
